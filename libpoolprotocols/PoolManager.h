...
struct PoolSettings
{
    ...
    bool olivetum = false;              // Use Olivetumhash RPC/params
    bool benchmarkOlivetum = false;     // Use Olivetumhash benchmark instead of ethash
    int benchmarkOlivetumEpoch = 0;     // Epoch for Olivetumhash benchmark
};
