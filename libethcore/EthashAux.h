...
struct EpochContext
{
    ...
    // When isOlivetum == true, DAG/light fields are ignored and miner should
    // use olivetumDataset as the data source.
    bool isOlivetum = false;
    std::shared_ptr<std::vector<uint8_t>> olivetumDataset;
};
